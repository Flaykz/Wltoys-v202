...
uint8_t nRF24::txMode(uint8_t initialFreq)
{
  ...
  if (read_register(STATUS) & 0x80) {
    Serial.write("BK2421!\n");
    long nul = 0;
    write_register(0x00, (const uint8_t *) "\x40\x4B\x01\xE2", 4);
    write_register(0x01, (const uint8_t *) "\xC0\x4B\x00\x00", 4);
    write_register(0x02, (const uint8_t *) "\xD0\xFC\x8C\x02", 4);
    write_register(0x03, (const uint8_t *) "\xF9\x00\x39\x21", 4);
    write_register(0x04, (const uint8_t *) "\xC1\x96\x9A\x1B", 4);
    write_register(0x05, (const uint8_t *) "\x24\x06\x7F\xA6", 4);
    write_register(0x06, (const uint8_t *) &nul, 4);
    write_register(0x07, (const uint8_t *) &nul, 4);
    write_register(0x08, (const uint8_t *) &nul, 4);
    write_register(0x09, (const uint8_t *) &nul, 4);
    write_register(0x0A, (const uint8_t *) &nul, 4);
    write_register(0x0B, (const uint8_t *) &nul, 4);
    write_register(0x0C, (const uint8_t *) "\x00\x12\x73\x00", 4);
    write_register(0x0D, (const uint8_t *) "\x46\xB4\x80\x00", 4);
    write_register(0x0E, (const uint8_t *) "\x41\x10\x04\x82\x20\x08\x08\xF2\x7D\xEF\xFF", 11);
    write_register(0x04, (const uint8_t *) "\xC7\x96\x9A\x1B", 4);
    write_register(0x04, (const uint8_t *) "\xC1\x96\x9A\x1B", 4);
  }
